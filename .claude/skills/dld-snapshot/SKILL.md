...
```bash
bash .claude/skills/dld-snapshot/scripts/update-snapshot-state.sh [ARTIFACT_NAME...]
```

For example, if custom artifacts `ONBOARDING.md` and `API-CONTRACTS.md` were generated:

```bash
bash .claude/skills/dld-snapshot/scripts/update-snapshot-state.sh ONBOARDING.md API-CONTRACTS.md
```
